...
@endphp
<nav x-data="{ open: false }" class="background-color border-b border-on-surface-color z-50 sticky top-0">
                        ...
                        <div class="ml-3 relative">
                            <x-dropdown align="right" width="60">
                                ...
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 background-color hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
