...
<nav x-data="{ open: false }" class="background-color border-b z-50 sticky top-0">
                ...
                <!-- Teams Dropdown -->
                    @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                        <div class="ml-3 relative">
                            <x-widgets.dropdown align="right" width="60">
                                <x-slot name="trigger">
                                ...
                                <x-slot name="content">
                                    <div class="w-60">
                                        ...
                                        @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                                            <x-navlink.dropdown href="{{ route('teams.create') }}">
                                                {{ __('Create New Team') }}
                                            </x-navlink.dropdown>
                                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if($userRole == 'Admin')
                    <x-responsive-nav-link href="{{ route('manage.users') }}"
                                           :active="request()->routeIs('manageusers')">
                        {{ __('Manage Users') }}
                    </x-responsive-nav-link>
                @endif
