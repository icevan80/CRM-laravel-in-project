<div>
    ...
    @if(auth()->user()->hasPermission('edit_other_appointment'))
        <x-inputs.select id="implementer" class="border text-gray-900  border-gray-300 rounded-lg"
    ...
    @else
        <p>{{ auth()->user()->name }}</p>
    @endif
    <x-inputs.select id="service" class="border text-gray-900  border-gray-300 rounded-lg"
                   label="{{ __('Service') }}"
    ...
    <x-input.date id="date" type="date" class="border text-gray-900  border-gray-300 rounded-lg"
                  label="{{ __('Date') }}"
    ...
    <div class="time-block">
        <x-inputs.select id="time" class="border text-gray-900  border-gray-300 rounded-lg"
