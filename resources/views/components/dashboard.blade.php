<x-app-layout>
    ...
    <div class="py-12">
        ...
        {{--        <div x-data="{ open: screen.width > 640 ? true : false }" id="dashboard-grid" :style="display: grid; grid-template-columns: ${screen.width > 640?'1fr 4fr' : '0rf 4fr' } ;">--}}
        <div x-data="{ open: screen.width > 640 ? true : false }" id="dashboard-grid">
            {{-- Sidebar --}}
            ...
            <div
                ...
                class="">
                <div x-show="!open" class="dashboard-menu-dropdown -mr-2 flex items-center sm:hidden"
                >
                    ...
                    <div class="fixed flex flex-col top-0 left-0 w-64 bg-white h-full " style="z-index: 20">
                        ...
                        <div class="overflow-y-auto overflow-x-hidden flex-grow">
                            ...
                            <ul class="flex flex-col py-4 space-y-1">
                                <li>
                                    <div x-show="open" class="-mr-2 flex items-center sm:hidden"
                                    >
                                        <button @click="open = ! open"
                                                class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
                                            <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                                    ...
                                    <li>
                                      ...
                                      <span class="inline-flex justify-center items-center ml-4">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                            ...
                                            <span class="ml-2 text-sm tracking-wide truncate">Translation</span>
                                        </a>
                                    </li>
                                @endif
                                    ...
                                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"
                                        ...
                                        <path
                                            ...
                                            stroke-linejoin="round"/>
                                                ...
                                                <span
                                                    class="ml-2 text-sm tracking-wide truncate">Manage Locations</span>
                        ...
                        {{ request()->is('dashboard/manage/appointments') ? 'bg-gray-100 border-pink-500 text-gray-900 font-semibold' : '' }}
                          ...
                          <span class="inline-flex justify-center items-center ml-4">
                            <svg fill="currentColor" class="w-5 h-5" viewBox="0 0 24 24" data-name="Layer 1"
                                 id="Layer_1" xmlns="http://www.w3.org/2000/svg"><title/><path
                                    d="M18,5V3a1,1,0,0,0-2,0V5H8V3A1,1,0,0,0,6,3V5H2V21H22V5Zm2,14H4V7H20Zm-7-9H11v2h2Zm4,0H15v2h2ZM9,14H7v2H9Zm4,0H11v2h2Z"/></svg>
                          </span>
                              ...
                              <span class="inline-flex justify-center items-center ml-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                     class="bi bi-award" viewBox="0 0 16 16"> <path
                                        ...
                                        d="M4 11.794V16l4-1 4 1v-4.206l-2.018.306L8 13.126 6.018 12.1 4 11.794z"/> </svg>
                              </span>
