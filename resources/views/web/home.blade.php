...
-->
        ...
        <section class="pt-5 background-color">
            <div class="md:w-4/5 mx-auto">
                ...
                <div class="flex flex-col md:flex-row mt-3 pb-7 h-max">
                    ...
                    <div
                        class="mx-auto w-80 pb-20 transform overflow-hidden rounded-lg background-color shadow-md duration-300 hover:scale-105 hover:shadow-lg">
                        <img class="h-48 w-full object-cover object-center" src="{{ asset('images/hair-cut.jpg')}}"
                             alt="Product Image"/>
                        <div class="p-4">
                            <h2 class="mb-2 text-lg font-medium  text-gray-900">Hair Cut</h2>
                            <p class="mb-2 text-base text-gray-700">Types of hair cuts available: Layered, Bangs, Pixie
                                cut.</p>
                    ...
                    <div
                        class="mx-auto w-80 pb-20 transform overflow-hidden rounded-lg background-color shadow-md duration-300 hover:scale-105 hover:shadow-lg">
                        <img class="h-48 w-full object-cover object-center" src="{{ asset('images/hair-coloring.jpg')}}"
                             alt="Product Image"/>
                        <div class="p-4">
                            <h2 class="mb-2 text-lg font-medium  text-gray-900">Hair Coloring</h2>
                            <p class="mb-2 text-base text-gray-700">Get your hair colored by our professional hair
                                stylists.</p>
                    ...
                    <div
                        class="mx-auto w-80 pb-20 transform overflow-hidden rounded-lg background-color shadow-md duration-300 hover:scale-105 hover:shadow-lg">
                        <img class="h-48 w-full object-cover object-center" src="{{ asset('images/nail-coloring.jpg')}}"
                             alt="Product Image"/>
                        <div class="p-4">
            ...
            <div class="flex justify-end mx-auto pb-5 gap-3 md:w-3/4">
                ...
                <a href="{{route('services')}}"
                   class="primary-color hover:bg-darken-35 text-white font-bold py-2 px-4 rounded">
                    View All Services
                </a>
            </div>
            {{--
      ...
      Browse Services    </a> --}}
        ...
        <section class=" w-3/4 p-3 mx-auto pt-5">
            ...
            <div class="flex gap-10 ">
                <div class="max-w-sm p-6 background-color border border-gray-200 rounded-lg shadow ">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">15% Off for Combank Credit
                            Cards</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 ">Offer Valid till 30th Of July 2023</p>
                    <a href="#"
                       class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white primary-color rounded-lg hover:bg-darken-35 focus:ring-4 focus:outline-none focus:ring-pink-300 ">
                        View Offer
                ...
                <div class="max-w-sm p-6 background-color border border-gray-200 rounded-lg shadow ">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">12% Off for Promo Code:
                            HAIR2023</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 ">Offer Valid till 30th Of July 2023</p>
                    <a href="#"
        ...
        <section class="mb-12" id="offer-banner">
            ...
            <div
                class="primary-color border-t alert alert-dismissible fade show fixed bottom-0 right-0 left-0 z-[1030] w-full py-4 px-6 text-white md:flex justify-between items-center text-center md:text-left">
