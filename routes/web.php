            ...
            Route::prefix('manage')->group(function () {
                ...
                Route::middleware([
                    ...
                    Route::controller(DealsController::class)->group(function () {
                        Route::get('/deals', 'index')->name('manage.deals');
                        Route::put('/deals/store', 'store')->name('manage.deals.store');
                        Route::put('/deals/{id}/update', 'update')->name('manage.deals.update');
                        Route::put('/deals/{id}/destroy', 'destroy')->name('manage.deals.destroy');
                    });
                });
                Route::middleware([
